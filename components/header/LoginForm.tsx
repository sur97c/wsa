...
import { faSignInAlt, faPaperPlane, faArrowLeft, faArrowRight } from '@fortawesome/free-solid-svg-icons'
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className='md:w-auto w-full'>
                            <div className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0">
                                ...
                                <div className="flex justify-center md:justify-start md:flex-1 md:hidden">
                                    <label className="cursor-pointer md:flex-none text-primary hover:text-primary-hover hover:font-bold">
                                        ...
                                        />
                                        <span className="ml-2 text-sm">{t('loginForm.rememberMe')}</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 md:hidden w-full">
                                <LoadingButton
                                    type="submit"
                                    aria-label={loading ? t(translations.loginForm.signingIn) : t(translations.loginForm.signIn)}
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb:ml-2 mb:mr-2">
                                <div className="w-full sm:flex-grow">
                                    <label htmlFor="recover-email" className="block text-sm font-medium text-dark mb-2 sm:mb-0 sm:mr-2">
                                ...
                                <div className="w-full sm:w-auto">
                                    <LoadingButton
                                        ...
                                        aria-label={loading ? t(translations.loginForm.sendingEmail) : t(translations.loginForm.sendEmail)}
